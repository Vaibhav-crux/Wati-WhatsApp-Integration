...
class WhatsAppService {
  public async sendWhatsAppMessage(phoneNumber: string, otp: string): Promise<void> {
  ...
  public async sendWhatsAppMagicLink(phoneNumber: string, magicLinkUrl: string): Promise<void> {
    const url = `${api_endpoint}/api/v2/sendTemplateMessage?whatsappNumber=${phoneNumber}`;
